 ...
 * @ngdoc service
 * @name $mmaModHsuforumSync
 */
.factory('$mmaModHsuforumSync', function($q, $log, $mmApp, $mmSitesManager, $mmaModHsuforumOffline, $mmSite, $mmEvents, $mmSync, $mmLang,
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumSync#syncAllForums
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumSync#syncForumDiscussionsIfNeeded
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumSync#syncForumDiscussions
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumSync#syncForumReplies
     * @param  {Number}     forumId                 Forum ID to be synced.
     * @param  {Number}     [userId]                User the discussions belong to.
     * @param  {String}     [siteId]                Site ID. If not defined, current site.
     * @return {Promise}                            Promise resolved if sync is successful, rejected otherwise.
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumSync#syncDiscussionRepliesIfNeeded
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumSync#syncDiscussionReplies
     * @param  {Number} discussionId  Discussion ID to be synced.
     * @param  {Number} [userId]      User the posts belong to.
     * @param  {String} [siteId]      Site ID. If not defined, current site.
     * @return {Promise}              Promise resolved if sync is successful, rejected otherwise.
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumSync#getForumSyncId
     * @param  {Number} forumId  Forum ID.
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumSync#getDiscussionSyncId
