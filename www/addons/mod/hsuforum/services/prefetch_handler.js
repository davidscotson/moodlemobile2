 ...
 * @ngdoc service
 * @name $mmaModHsuforumPrefetchHandler
 */
.factory('$mmaModHsuforumPrefetchHandler', function($mmaModHsuforum, mmaModHsuforumComponent, $mmFilepool, $mmSite, $q, $mmUtil, $mmUser,
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumPrefetchHandler#download
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumPrefetchHandler#getFiles
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumPrefetchHandler#getRevision
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumPrefetchHandler#getTimemodified
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumPrefetchHandler#invalidateContent
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumPrefetchHandler#invalidateModule
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumPrefetchHandler#isEnabled
     * @return {Boolean}
     */
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumPrefetchHandler#prefetch
     * @param  {Object} module   The module object returned by WS.
     * @param  {Number} courseId Course ID the module belongs to.
