 ...
 * @ngdoc service
 * @name $mmaModHsuforumHandlers
 */
.factory('$mmaModHsuforumHandlers', function($mmCourse, $mmaModHsuforum, $state, $mmUtil, $mmContentLinksHelper, $q, $mmEvents, $mmSite,
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumHandlers#courseContent
     */
    self.courseContent = function() {
         ...
         * @module mm.addons.mod_hsuforum
         * @ngdoc method
         * @name $mmaModHsuforumCourseContentHandler#isEnabled
         * @return {Boolean}
         */
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumHandlers#linksHandler
     */
     ...
     * @module mm.addons.mod_hsuforum
     * @ngdoc method
     * @name $mmaModHsuforumHandlers#syncHandler
     */
