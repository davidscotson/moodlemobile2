 ...
 * @ngdoc controller
 * @name mmaModHsuforumNewDiscussionCtrl
 */
.controller('mmaModHsuforumNewDiscussionCtrl', function($scope, $stateParams, $mmGroups, $q, $mmaModHsuforum, $mmEvents, $ionicPlatform,
