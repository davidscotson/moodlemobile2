 ...
 */
.directive('mmaModHsuforumDiscussionPost', function($mmaModHsuforum, $mmUtil, $translate, $q, $mmaModHsuforumOffline, $mmSyncBlock,
    ...
    return {
        ...
        templateUrl: 'addons/mod/hsuforum/templates/discussionpost.html',
        transclude: true,
        link: function(scope) {
            var syncId;
